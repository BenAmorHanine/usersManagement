...
router.get('/users/condidats',authMiddleware.protect,authMiddleware.restrictTo('admin'), userController.getCondidats); //getsimpleusersmaaneha
...
router.put('/users/:id/role/test',authMiddleware.protect,authMiddleware.restrictTo(['admin','responsible-testor']), userController.updateRoleToTestor);
